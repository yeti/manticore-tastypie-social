...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SocialProvider.action_type'
        db.delete_column(u'manticore_tastypie_social_socialprovider', 'action_type')

        # Adding field 'SocialProvider.name'
        db.add_column(u'manticore_tastypie_social_socialprovider', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SocialProvider.action_type'
        db.add_column(u'manticore_tastypie_social_socialprovider', 'action_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=''),
                      keep_default=False)

        # Deleting field 'SocialProvider.name'
        db.delete_column(u'manticore_tastypie_social_socialprovider', 'name')
