...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Like', fields ['object_id']
        db.create_index(u'manticore_tastypie_social_like', ['object_id'])


    def backwards(self, orm):
        # Removing index on 'Like', fields ['object_id']
        db.delete_index(u'manticore_tastypie_social_like', ['object_id'])
