...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Flag', fields ['user_profile', 'content_type', 'object_id']
        db.create_unique(u'manticore_tastypie_social_flag', ['user_profile_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Flag', fields ['user_profile', 'content_type', 'object_id']
        db.delete_unique(u'manticore_tastypie_social_flag', ['user_profile_id', 'content_type_id', 'object_id'])
