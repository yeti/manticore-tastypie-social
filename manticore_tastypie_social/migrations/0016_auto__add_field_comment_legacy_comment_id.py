...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.legacy_comment_id'
        db.add_column(u'manticore_tastypie_social_comment', 'legacy_comment_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.legacy_comment_id'
        db.delete_column(u'manticore_tastypie_social_comment', 'legacy_comment_id')
