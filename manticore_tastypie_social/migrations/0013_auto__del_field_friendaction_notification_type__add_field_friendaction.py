...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FriendAction.notification_type'
        db.delete_column(u'manticore_tastypie_social_friendaction', 'notification_type')

        # Adding field 'FriendAction.action_type'
        db.add_column(u'manticore_tastypie_social_friendaction', 'action_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')())


    def backwards(self, orm):
        # Adding field 'FriendAction.notification_type'
        db.add_column(u'manticore_tastypie_social_friendaction', 'notification_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=''),
                      keep_default=False)

        # Deleting field 'FriendAction.action_type'
        db.delete_column(u'manticore_tastypie_social_friendaction', 'action_type')
