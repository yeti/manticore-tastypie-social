...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'manticore_tastypie_social_follow', (
            ...
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forecast.UserProfile'])),
        ))
        db.send_create_signal(u'manticore_tastypie_social', ['Follow'])

        # Adding unique constraint on 'Follow', fields ['user_profile', 'content_type', 'object_id']
        db.create_unique(u'manticore_tastypie_social_follow', ['user_profile_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Follow', fields ['user_profile', 'content_type', 'object_id']
        db.delete_unique(u'manticore_tastypie_social_follow', ['user_profile_id', 'content_type_id', 'object_id'])
    ...
    models = {
        ...
        u'manticore_tastypie_social.follow': {
            'Meta': {'unique_together': "(('user_profile', 'content_type', 'object_id'),)", 'object_name': 'Follow'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
