...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'NotificationSetting', fields ['notification_type', 'user_profile']
        db.create_unique(u'manticore_tastypie_social_notificationsetting', ['notification_type', 'user_profile_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'NotificationSetting', fields ['notification_type', 'user_profile']
        db.delete_unique(u'manticore_tastypie_social_notificationsetting', ['notification_type', 'user_profile_id'])
