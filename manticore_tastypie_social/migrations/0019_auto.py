...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Notification', fields ['object_id']
        db.create_index(u'manticore_tastypie_social_notification', ['object_id'])

        # Adding index on 'FriendAction', fields ['object_id']
        db.create_index(u'manticore_tastypie_social_friendaction', ['object_id'])


    def backwards(self, orm):
        # Removing index on 'FriendAction', fields ['object_id']
        db.delete_index(u'manticore_tastypie_social_friendaction', ['object_id'])

        # Removing index on 'Notification', fields ['object_id']
        db.delete_index(u'manticore_tastypie_social_notification', ['object_id'])
    ...
    models = {
        ...
        u'forecast.userprofile': {
            ...
            'default_feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manticore_tastypie_social.Follow']", 'null': 'True', 'blank': 'True'}),
            'default_social_providers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['manticore_tastypie_social.SocialProvider']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'legacy_account_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'original_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture_overlay': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'manticore_tastypie_social.notification': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receiver'", 'to': u"orm['forecast.UserProfile']"})
        },
