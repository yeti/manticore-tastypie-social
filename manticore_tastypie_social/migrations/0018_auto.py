...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'manticore_tastypie_social_comment', ['object_id'])

        # Adding index on 'Follow', fields ['object_id']
        db.create_index(u'manticore_tastypie_social_follow', ['object_id'])


    def backwards(self, orm):
        # Removing index on 'Follow', fields ['object_id']
        db.delete_index(u'manticore_tastypie_social_follow', ['object_id'])

        # Removing index on 'Comment', fields ['object_id']
        db.delete_index(u'manticore_tastypie_social_comment', ['object_id'])
