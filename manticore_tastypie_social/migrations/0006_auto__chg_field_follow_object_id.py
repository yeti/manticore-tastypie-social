...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'manticore_tastypie_social_follow', 'object_id', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Follow.object_id'
        db.alter_column(u'manticore_tastypie_social_follow', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
