...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.user_profile'
        db.delete_column(u'manticore_tastypie_social_notification', 'user_profile_id')

        # Adding field 'Notification.receiver'
        db.add_column(u'manticore_tastypie_social_notification', 'receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver', to=orm['forecast.UserProfile']),
                      keep_default=False)

        # Adding field 'Notification.reporter'
        db.add_column(u'manticore_tastypie_social_notification', 'reporter',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reporter', null=True, to=orm['forecast.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Notification.user_profile'
        db.add_column(u'manticore_tastypie_social_notification', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['forecast.UserProfile']),
                      keep_default=False)

        # Deleting field 'Notification.receiver'
        db.delete_column(u'manticore_tastypie_social_notification', 'receiver_id')

        # Deleting field 'Notification.reporter'
        db.delete_column(u'manticore_tastypie_social_notification', 'reporter_id')
