...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'manticore_tastypie_social_comment', 'description', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Comment.description'
        db.alter_column(u'manticore_tastypie_social_comment', 'description', self.gf('django.db.models.fields.CharField')(max_length=120))
