...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AirshipToken', fields ['user_profile']
        db.delete_unique(u'manticore_tastypie_social_airshiptoken', ['user_profile_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'AirshipToken', fields ['user_profile']
        db.create_unique(u'manticore_tastypie_social_airshiptoken', ['user_profile_id'])
